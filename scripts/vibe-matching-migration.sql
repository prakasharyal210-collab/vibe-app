-- ===========================================================================
-- Vibe Smart Matching: Migration (canonical, schema-verified)
-- Run via Management API or Supabase SQL Editor.
--
-- Real profiles columns used: id, username, full_name, avatar_url, bio, age,
--   gender, interests, relationship_goal, is_verified, last_active, created_at,
--   show_in_matching, location
-- vibe_matches columns: id, sender_id, receiver_id, status
-- NOTE: vibe_scores is an existing gamification table — we use vibe_compat_scores
-- ===========================================================================
...
-- 2. vibe_compat_scores — compatibility score cache per user-target pair
-- (vibe_scores is an existing gamification table — do NOT touch it)
...
-- Drop old 5-arg version if it still exists
