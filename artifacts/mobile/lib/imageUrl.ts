 ...
 *   https://<project>.supabase.co/storage/v1/render/image/public/<bucket>/<path>?width=W&height=H&resize=cover&quality=Q
 *
...
const PRESETS: Record<Exclude<ImageSizePreset, "full">, { width: number; height: number; quality: number }> = {
  ...
  thumbnail: { width: 200, height: 200, quality: 65 },
  ...
  // 2500px+ upload.
  card: { width: 800, height: 800, quality: 75 },
};
...
export function getTransformedImageUrl(
  ...
  return `${rewritten}${separator}width=${width}&height=${height}&resize=cover&quality=${quality}`;
}
