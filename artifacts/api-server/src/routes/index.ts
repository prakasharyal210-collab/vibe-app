...
import adminFirstPostsRouter from "./admin/first-posts";
...
import reelsDownloadRouter from "./reels/download";
...
router.use("/admin", adminFirstPostsRouter);
...
router.use("/reels", reelsDownloadRouter);
